...
vg map -% -d $workingdir/hg19-path-chop1024.gfa -b $bamdir/$SAMPLE.illumina-prdm9-10k.bam -I 5000:$FRAG:$STD:0:1 > $aligndir/$SAMPLE-align-GRCh38-frag.gaf
if [ $? -ne 0 ]; then fail "grch failed"; fi
vg map -% -d $workingdir/stacked-path-chop1024.gfa -b $bamdir/$SAMPLE.illumina-prdm9-10k.bam -I 5000:$FRAG:$STD:0:1 > $aligndir/$SAMPLE-align-graph-frag.gaf
