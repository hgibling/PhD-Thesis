...
vg map -d znf-loop-nopath-chop1024 -f /.mounts/labs/awadallalab/private/hgibling/PRDM9-Project/HMM/simulations/READS/haploid/100/reads/$a-flank10k-100-bp-250-frag-100-x-e-0.001-i-$i.r1.fq -f /.mounts/labs/awadallalab/private/hgibling/PRDM9-Project/HMM/simulations/READS/haploid/100/reads/$a-flank10k-100-bp-250-frag-100-x-e-0.001-i-$i.r2.fq -I 5000:250:50:0:1 -U -% | sed 's/dv:f://' | awk -v a="$a" -v i="$i" -v OFS="," '{print a, "znf-loop", "nopath", "100", "0.001", i, $1, $16}' >> /.mounts/labs/awadallalab/private/hgibling/PRDM9-Project/HMM/alignments/$a-znf-loop-nopath-100-0.001-vg-frag-fixed-deviations.csv
