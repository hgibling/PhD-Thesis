...
time $gbkcdir/gbkc count -a $prdm9dir/all-alleles-standard.fa -1 $fqdir/$sample-CCS-targeted-PRDM9-gap-filtered-maxima-nosoft.fq -d -k 21 -K 221 -i 20 -f $prdm9dir/flank-custom-OHS.fa -m median -e $err -c $cov -l $modelength -N 10 -o $savedir/$sample.filtered-maxima-nosoft-median-PRDM910k-stats-flank.tsv
