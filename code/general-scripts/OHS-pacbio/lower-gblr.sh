...
savedir=$basedir/gblr-calls-lower-e
...
$gblrdir/gblr.py -a $prdm9dir/all-alleles-standard-flank10k.fa -r $bamdir/$sample-CCS-targeted-PRDM9-gap-filtered-maxima.bam -d -N 10 -c -e 0.001 -s e -E allIndel -o $savedir/$sample-gblr-GRCh38.tsv
