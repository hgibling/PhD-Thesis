...
$gblrdir/gblr.py -a $prdm9dir/all-alleles-standard-flank10k.fa -r $basedir/mapped-GRCh38-filtered-maxima/$sample-CCS-targeted-PRDM9-gap-filtered-maxima.bam -d -c -e 0.01 -s 1ee -E 1Indel -x consensus -o $savedir/$sample-gblr-GRCh38-consensus-only.tsv
