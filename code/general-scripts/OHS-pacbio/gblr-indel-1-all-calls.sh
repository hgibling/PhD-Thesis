...
$gblrdir/gblr.py -a $prdm9dir/all-alleles-standard-flank10k.fa -r $bamdir/$sample-CCS-targeted-PRDM9-gap-filtered-maxima.bam -d -N 10 -c -e 0.01 -s e -E 1Indel -o $savedir/$sample-gblr-GRCh38.tsv
