...
$gblrdir/gblr.py -a $prdm9dir/all-alleles-standard-flank10k.fa -r $basedir/GRCh38-bams/$sample-ccs-prdm9-10k-GRCh38.bam -d -N 10 -c -s 1e -E allIndel -e 0.01 -o $savedir/$sample-gblr-GRCh38-1e-all.tsv
