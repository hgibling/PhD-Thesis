...
time $gbkcdir/gbkc count -a $prdm9dir/all-alleles-standard.fa -1 $fqdir/$sample-ccs-prdm9-10k.fq -d -k 21 -K 661 -i 20 -f $prdm9dir/flank10k.fa -m median -e $err -c $cov -l $modelength -N 10 -o $savedir/$sample-median-PRDM910k-stats-flank.tsv
