...
$gblrdir/gblr.py -a $prdm9dir/all-alleles-standard-flank10k.fa -r $basedir/GRCh38-bams/$sample-ccs-prdm9-10k-GRCh38.bam -d -N 10 -c -e 0.001 -s e -E 1Indel -o $savedir/$sample-gblr-GRCh38.tsv
