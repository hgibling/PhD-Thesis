...
$gblrdir/gblr.py -a $prdm9dir/all-alleles-flank10k.fa -r $basedir/GRCh38-bams/$sample-ccs-prdm9-10k-GRCh38.bam -d  -c -e 0.01 -s 1ee -E 1Indel -x consensus -o $savedir/$sample-gblr-GRCh38-consensus-only-36.tsv
