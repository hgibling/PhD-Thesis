...
do
	...
	do
		...
		then
			$gbkcdir/gbkc distance -a $prdm9dir/all-alleles-flank10k.fa -1 $simdir/$2/reads/$a-flank10k-$3-bp-$6-frag-$2-x-e-$4-i-$i.r1.fq -2 $simdir/$2/reads/$a-flank10k-$3-bp-$6-frag-$2-x-e-$4-i-$i.r2.fq -k $7 -l $3 -e $4 -c $2 -f $6 -s 50 -m $8 -o $simdir/$2/scores/$a-flank10k-$3-bp-$6-frag-$2-x-e-$4-i-$i-F-$7-k-$8-scores.csv
