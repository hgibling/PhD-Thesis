...
python call-alleles.py -a all-alleles.csv -r $readdir/$a-noflank-100-bp-250-frag-100-x-e-0-i-$i.r12.reads -e 0.001 -o $savedir/$a-noflank-100-bp-250-frag-100-x-e-0-i-$i-scores
