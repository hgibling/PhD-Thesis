...
a=A
i=1
python $hmmdir/call-alleles.py -a $hmmdir/all-alleles.csv -r $readdir/$a-noflank-100-bp-250-frag-20-x-e-0-i-$i.r12.reads -e 0.0000000001 -o $savedir/$a-noflank-100-bp-250-frag-20-x-e-0-i-$i-scores-TEST
