...
$gbkcdir/gbkc count -a $prdm9dir/all-alleles.fa -f $prdm9dir/flank10k.fa -1 $triodir/$sample-2x250-GIAB-PRDM9-r1.fq -2 $triodir/$sample-2x250-GIAB-PRDM9-r2.fq -d -K $k -m mean -e $err -c $cov -l $len -o $triodir/$sample-2x250-mean-scores.tsv
