...
$gbkcdir/gbkc count -a $prdm9dir/all-alleles.fa -f $prdm9dir/flank10k.fa -1 $triodir/$sample-300x-GIAB-PRDM9-r1-aligncorrect.fa -2 $triodir/$sample-300x-GIAB-PRDM9-r2-aligncorrect.fa -d -K $k -m coverage -e $err -c $cov -l $len -o $triodir/$sample-300x-coverage-scores-corrected.tsv
