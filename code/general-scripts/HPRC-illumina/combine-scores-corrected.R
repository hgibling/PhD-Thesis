...
count.path <- paste(illumina.path, "gbkc-calls-corrected", sep="/")
distance.path <- paste(illumina.path, "gbkc-distance-calls-corrected", sep="/")
...
write.table(combined, paste0(illumina.path, "/combined-calls-corrected/", sample,
