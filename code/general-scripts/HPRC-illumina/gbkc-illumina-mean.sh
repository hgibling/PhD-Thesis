...
$gbkcdir/gbkc count -a $prdm9dir/all-alleles-standard.fa -1 $sampledir/$sample/illumina/$sample-illumina-GRCh38-prdm9-10k.r1.fastq -2 $sampledir/$sample/illumina/$sample-illumina-GRCh38-prdm9-10k.r2.fastq -d -K 141 -N 10 -f $prdm9dir/flank10k.fa -m mean -e 0.01 -c 40 -l 151 -t 4 -o $savedir/$sample-mean-flank.tsv
