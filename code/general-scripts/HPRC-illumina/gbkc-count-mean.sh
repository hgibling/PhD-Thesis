...
time $gbkcdir/gbkc count -a $prdm9dir/all-alleles-standard.fa -1 $fqdir/$sample.illumina-prdm9-10k-filtered.r1.fq -2 $fqdir/$sample.illumina-prdm9-10k-filtered.r2.fq -d -K $k -f $prdm9dir/flank10k.fa -m mean -e $err -c $cov -l $len -o $savedir/$sample.filtered-mean-PRDM910k-stats-flank.tsv
