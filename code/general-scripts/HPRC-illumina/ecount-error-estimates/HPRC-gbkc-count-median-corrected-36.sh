...
time $gbkcdir/gbkc count -a $prdm9dir/all-alleles.fa -1 $fqdir/$sample.illumina-prdm9-10k-filtered-paired-corrected.r1.fa -2 $fqdir/$sample.illumina-prdm9-10k-filtered-paired-corrected.r2.fa -d -K $k -f $prdm9dir/flank10k.fa -m median -e $err -c $cov -l $len -o $calldir/$sample.filtered-paired-median-ecount-corrected-36.tsv
