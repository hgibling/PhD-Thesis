...
bwa mem -Y -K 100000000 -t 16 $refdir/GRCh38_full_analysis_set_plus_decoy_hla.fa $savedir/$sample/illumina/$sample-illumina-r1.fastq.gz $savedir/$sample/illumina/$sample-illumina-r1.fastq.gz > $savedir/$sample/illumina/$sample-illumina-GRCh38.unsorted.sam
