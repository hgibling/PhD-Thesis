...
count.path <- paste(illumina.path, "gbkc-calls-36", sep="/")
distance.path <- paste(illumina.path, "gbkc-distance-calls-36", sep="/")
...
write.table(combined, paste0(illumina.path, "/combined-calls-36/", sample,
