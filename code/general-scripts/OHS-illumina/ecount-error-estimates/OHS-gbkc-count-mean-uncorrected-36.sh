...
time $gbkcdir/gbkc count -a $prdm9dir/all-alleles.fa -1 $fqdir/$sample.filtered-illumina-prdm9-10k-GRCh38_paired.r1.fq -2 $fqdir/$sample.filtered-illumina-prdm9-10k-GRCh38_paired.r2.fq -d -K $k -f $prdm9dir/flank10k.fa -m mean -e $err -c $cov -l $len -o $calldir/$sample.filtered-paired-mean-ecount-uncorrected-36.tsv
