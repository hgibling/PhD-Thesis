...
$gbkcdir/gbkc count -a $prdm9dir/all-alleles-standard.fa -1 $sampledir/${sample}_illumina-prdm9-10k-GRCh38_r1.fq -2 $sampledir/${sample}_illumina-prdm9-10k-GRCh38_r2.fq -d -K 131 -N 10 -f $prdm9dir/flank10k.fa -m mean -e 0.01 -c 40 -l 151 -o $savedir/${sample}_mean-flank.tsv
