...
count.path <- paste(base.path, "gbkc-count-calls", sep="/")
distance.path <- paste(base.path, "gbkc-distance-calls", sep="/")
...
write.table(combined, paste0(base.path, "/combined-calls/", sample,
