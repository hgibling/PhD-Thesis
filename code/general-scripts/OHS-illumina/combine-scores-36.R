...
count.path <- paste(base.path, "gbkc-count-calls-36", sep="/")
distance.path <- paste(base.path, "gbkc-distance-calls-36", sep="/")
...
write.table(combined, paste0(base.path, "/combined-calls-36/", sample,
                             "-filtered-paired-combined-calls-top100.tsv"),
